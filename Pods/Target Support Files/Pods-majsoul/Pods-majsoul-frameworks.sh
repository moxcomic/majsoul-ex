...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NSURLProtocolWebKitSupport/NSURLProtocolWebKitSupport.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RASFloatingBall/RASFloatingBall.framework"
